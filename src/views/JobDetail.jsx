...
//       </div>
//       <div className="mt-6">
//         <a className="underline text-slate-700" onClick={()=>{}}>Open assessment builder for this job</a>
//       </div>
//     </div>
//   )
// }
...
export default function JobDetail({ match }) {
  const { id } = match
  const [job, setJob] = useState(null)
  const { navigate } = useRouter() // Add this line
    ...
    <div className="container-xl py-6">
      ...
      <div className="mt-6">
        <a
          ...
          onClick={() => navigate(`/jobs/${id}/assessment-builder`)}
          style={{ cursor: 'pointer' }}
        >
          Open assessment builder for this job
        </a>
      </div>
    </div>
  )
